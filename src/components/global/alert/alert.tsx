...
const variantDescriptionClasses: Record<AlertVariant, string> = {
  default: '',
...
export function Alert({
  ...
  return (
    <AlertPrimitive className={cn(variantClasses[variant], className)}>
      {resolvedIcon}
      <AlertTitle>{title}</AlertTitle>
      {description ? (
        <AlertDescription className={variantDescriptionClasses[variant]}>
          {description}
        </AlertDescription>
      ) : null}
    </AlertPrimitive>
